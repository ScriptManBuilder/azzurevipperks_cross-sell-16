      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Merchant Responsibility:</strong> Refund requests should be directed to the merchant, not to {process.env.REACT_APP_COMPANY_NAME}
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              These End-User Terms are governed by the laws of the State of {process.env.REACT_APP_COMPANY_STATE || 'Florida'}, United States, without regard to 
            ...
            <LegalList>
              ...
              <LegalListItem>
                <strong>Arbitration Location:</strong> Arbitration shall take place in {process.env.REACT_APP_ARBITRATION_CITY || 'Palm City'}, {process.env.REACT_APP_COMPANY_STATE || 'Florida'} or remotely by mutual agreement
              </LegalListItem>
              <LegalListItem>
