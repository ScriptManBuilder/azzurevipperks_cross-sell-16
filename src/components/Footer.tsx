...
const Footer: React.FC = () => {
  const brandName = process.env.REACT_APP_BRAND_NAME || 'Privexa';
  ...
  const supportEmail = process.env.REACT_APP_EMAIL_SUPPORT || 'support@azzurevipperks.com';
        ...
        <FooterGrid>
          <FooterSection>
            <FooterLogo>
              ...
              {process.env.REACT_APP_BRAND_NAME || 'Privexa'}
            </FooterLogo>
            <CompanyInfo>
              <p>{companyName}</p>
              <p>{companyAddress}</p>
